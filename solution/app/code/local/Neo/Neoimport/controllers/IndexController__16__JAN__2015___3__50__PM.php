				...
				$row = array_combine($header, $row);
					...
					if($product_id){
						...
						if(isset($row['IsLingerie']) && $row['IsLingerie']!=""){
							...
							$optionId = $this->addAttributeValue('is_lingerie',$row['IsLingerie']);
							//exit($optionId);
						...
						if(isset($row['IsCouples']) && $row['IsCouples']!=""){
							...
							$optionId = $this->addAttributeValue('is_couples',$row['IsCouples']);
							//exit($optionId);
						...
						if(isset($row['IsFetish']) && $row['IsFetish']!=""){
							...
							$optionId = $this->addAttributeValue('is_fetish',$row['IsFetish']);
							//exit($optionId);
						...
						if(isset($row['IsGayMale']) && $row['IsGayMale']!=""){
							...
							$optionId = $this->addAttributeValue('is_gay_male',$row['IsGayMale']);
							//exit($optionId);
						...
						if(isset($row['IsGayFemale']) && $row['IsGayFemale']!=""){
							...
							$optionId = $this->addAttributeValue('is_gay_female',$row['IsGayFemale']);
							//exit($optionId);
